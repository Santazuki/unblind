# Unblind — AI Agent 应用开发项目

> **DeepSeek can seek. Unblind lets it see.**
>
> DeepSeek 能求索，Unblind 让它看见。

> 🚀 全程使用 **Claude Code + Subagent-Driven Development** 开发，25+ AI Agent 协作。我作为 PM/架构决策者主导方向、审核设计、把关质量。
...
> 🚀 Built end-to-end with **Claude Code + Subagent-Driven Development**. 25+ AI Agents collaborated — I directed the architecture, reviewed every design, and made the calls.
...
This project is a real-world case study in Subagent-Driven Development. 25+ AI agents collaborated under my direction as PM/architect. [Proof doc](docs/design/multi-agent-usage-proof.md)
